...
自行到 `https://googlechromelabs.github.io/chrome-for-testing/` 下载对应版本的 `chromedriver`
...
目前来说，先知社区需要定时滑动来验证是否是真人，~~如果提示失败，则刷新页面即可。~~
，目前如果遇到验证，在测试页面中的验证无法正常执行，需要复制链接新开页面中验证即可，然后返回到爬取页面刷新即可。Freebuf无需验证。
